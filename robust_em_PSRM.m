function [klas, params, Posterior, gmm_density, stored_K, stored_J] = robust_em_PSRM(x, Y, spline_order, spline_type, nknots)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Robust EM algorithm for Polynomial Spline Regression Mixture Model (PSRM)
% M: Spline order
%
%
%
...
for k=1:K
    ...
    Sigmak2(k)=  Dk((ceil(sqrt(K))));%Dk(ceil(sqrt(K)));%.001;%%;%
...
%     Sigmak2(k) = 1/m*sum((Y_in(k,:) - muk').^2, 2);
